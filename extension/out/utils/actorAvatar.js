...
function generateAvatarVariant(seed, kind, styleVersion = 1) {
    ...
    return {
        ...
        accessory: kind === 'service' ? 'antenna' : pick(['none', 'visor', 'headband', 'badge', 'antenna'], hash, 6),
        eyeShape: pick(['dot', 'bar', 'wide'], hash, 13),
        mouthShape: pick(['flat', 'smile', 'focus'], hash, 17),
        shellShape: pick(['round', 'squircle'], hash, 21),
    };
}
