...
export class OnboardingPanel {
	...
	public static readonly viewType = 'guideai.onboarding';
		...
		try {
			...
			if (!status.is_bootstrapped) {
				const action = await vscode.window.showInformationMessage(
					'This workspace has not been set up with GuideAI. Would you like to configure it now?',
					'Set Up Workspace',
					'Not Now'
				);
