...
export class GuideAIChatPanel {
	public static currentPanel: GuideAIChatPanel | undefined;
	public static readonly viewType = 'guideai.chat';
...
• Use @toolname {...args} to call a specific tool`;
	...
	private _getHtmlForWebview(): string {
		...
		const styleUri = webview.asWebviewUri(
			vscode.Uri.joinPath(this._extensionUri, 'src', 'styles', 'GuideAIChatPanel.css')
		);
