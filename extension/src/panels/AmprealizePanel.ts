...
import { McpClient, AmprealizePlanResult, AmprealizeStatusResult, AmprealizeListBlueprintsResult } from '../client/McpClient';
...
export class AmprealizePanel {
	public static currentPanel: AmprealizePanel | undefined;

	public static readonly viewType = 'guideai.amprealize';
	...
	private _planResult: AmprealizePlanResult | null = null;
	private _runId: string | null = null;
	private _runStatus: AmprealizeStatusResult | null = null;

	private constructor(panel: vscode.WebviewPanel, extensionUri: vscode.Uri, client: GuideAIClient, mcpClient: McpClient) {
		this._panel = panel;
	...
	public static createOrShow(extensionUri: vscode.Uri, client: GuideAIClient, mcpClient: McpClient) {
