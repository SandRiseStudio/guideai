...
.. deprecated:: 2026-01-07
    ...
    - guideai/multi_tenant/auth_service.py for authentication
    - guideai/auth/providers/google.py for OAuth flow
...
class InternalAuthProvider(OAuthProvider):
    ...
    def __init__(
        ...
        warnings.warn(
            ...
            "MultiTenantAuthService instead. See guideai/auth/providers/google.py",
            DeprecationWarning,
            stacklevel=2,
        )
