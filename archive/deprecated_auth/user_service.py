...
.. deprecated:: 2026-01-08
    ...
    - guideai/multi_tenant/auth_service.py for user management
    - guideai/multi_tenant/organization_service.py for org/project management
...
class UserService:
    ...
    def __init__(self, dsn: Optional[str] = None):
        ...
        warnings.warn(
            ...
            "with auth.users table instead. See guideai/multi_tenant/auth_service.py",
            DeprecationWarning,
            stacklevel=2,
        )
